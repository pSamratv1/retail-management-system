...
export const containerClassName =
  ...
  pageClassName =
    "w-6 h-6 mx-1 flex justify-center items-center rounded-full hover:bg-primary-medium/70 dark:hover:bg-green-800 hover:text-white/80",
  pageLinkClassName = (paginationCount: number) =>
    paginationCount !== 0 ? "p-1" : "p-2",
  activeClassName = (paginationCount: number) =>
    paginationCount !== 0
      ? "rounded-lg bg-[#0E84ED] dark:bg-green-700 text-[#ffffff]"
      : "",
